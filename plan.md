...
**Goal:** Merge the design DNA of three reference sites into one distinctive, professional personal portfolio for Amir Javed (Full Stack Junior Developer). Deep analysis below, followed by the merged design system and a phased implementation plan against the existing Next.js codebase.
